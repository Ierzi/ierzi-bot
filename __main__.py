...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.idle, activity=CustomActivity(f"updating the bots pfp for pride month instead of working on an actual update lol - {guild_count} servers"))
    await fill_embeds()
