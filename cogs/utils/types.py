...
class Birthday:
    ...
    def __str__(self) -> str:
        return (
            f"{self.day:02d}/{self.month:02d}"
            if self.year is None
            else f"{self.day:02d}/{self.month:02d}/{self.year:04d}"
        )

    def __repr__(self) -> str:
        return (
            f"Birthday({self.day:02d}/{self.month:02d})"
            if self.year is None
            else f"Birthday({self.day:02d}/{self.month:02d}/{self.year:04d})"
        )
